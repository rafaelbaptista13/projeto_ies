...
public class Runner implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
	...
	public static final String[] var_nacionalidade_menor_probabilidade = {"Albanesa", "Austríaca","Búlgara","Croata","Dinamarquesa","Eslovaca","Eslovena","Finlandesa","Grega","Húngara","Islandesa","Irlandesa","Lituana","Luxemburguesa","Norueguesa","Polaca","Romena","Sueca","Suíca","Turca","Ucraniana","Argentina","Canadiana","Mexicana","Japonesa"};
