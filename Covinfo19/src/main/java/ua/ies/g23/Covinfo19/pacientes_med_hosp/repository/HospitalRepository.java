...
public interface HospitalRepository extends JpaRepository<Hospital, Long>{
	...
	List<Hospital> findAllFilters(@Param("strnome") String strnome,@Param("strconcelho") String strconcelho,@Param("strregiao") String strregiao,@Param("strnumero_camasmin") String strnumero_camasmin,@Param("strnumero_camasmax") String strnumero_camasmax,@Param("strnumero_camas_ocupadasmin") String strnumero_camas_ocupadasmin,@Param("strnumero_camas_ocupadasmax") String strnumero_camas_ocupadasmax);
